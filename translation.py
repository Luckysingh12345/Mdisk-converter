...
HELP_MESSAGE = '''**Hello, {}
I Am mdisk, Bulk Link Converter Bot. I Can Convert Links Directly From Your mdisk Account,**
...
• I can **Convert any** links or posts to your **mdisk** link / post. (Button Links Posts, Hidden links/Hyperlinks All Are Supported)
...
• **No** need to share **password or email** to convert links.**
 ...
 Anyone who want to use any **other shortner** instead of mdisk than **contact** at 👉 @luckysingh2006 (all **shortners support** available.)
...
START_MESSAGE_REPLY_MARKUP  = InlineKeyboardMarkup([
    [
        InlineKeyboardButton('Get Api', url=f'https://mypowerdisk.com/mybox')
    ]
])
...
USER_ABOUT_MESSAGE = """
- Website: [{base_site}](https://t.me/@Video_tool_money_tree_bot)
...
Get API From [{base_site}](https://t.me/@Video_tool_money_tree_bot)
...
USERNAME_TEXT = """**Hello Harman, I am Mdisk.com, Bulk Link Converter Bot From Linked shortnerfly.com Account,**
...
/channel @
Or
/channel https://t.me/@Video_tool_money_tree_bot

**🤘 Hit** 👉 /features To Know More Features Of This Bot.

**- Message @luckysingh2006 For More Help -**"""
